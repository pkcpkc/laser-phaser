...
export class AsteroidTexture {
    /**
     * Generates irregular polygon vertices for an asteroid shape
     */
    public static generateVertices(radius: number, vertexCount: number = 10): { x: number; y: number }[] {
    ...
    public static create(
        ...
        const vertices = AsteroidTexture.generateVertices(radius, 8 + Math.floor(Math.random() * 5));
