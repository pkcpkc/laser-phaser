...
describe('GalaxyRegistry (testing DemoGalaxy)', () => {
    let registry: BaseGalaxy;
    let mockScene: Phaser.Scene;

    beforeEach(() => {
        registry = new BaseGalaxy(DemoGalaxyConfig);
    ...
    it('should initialize Blood Hunters Galaxy', async () => {
        ...
        const { BaseGalaxy } = await import('../../../src/scenes/galaxies/base-galaxy');
        const bloodHunters = new BaseGalaxy(bloodHuntersGalaxyConfig);
